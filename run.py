...
from model.MVGCRN import MVGCRN as Network
from model.BasicTrainer import Trainer
from lib.TrainInits import init_seed
from lib.dataloader import get_dataloader
from lib.TrainInits import print_model_parameters
from lib.load_adj import load_adj
from lib.load_adj_poi import load_adj_poi
import warnings
...
# Mode = 'train'
# DEBUG = 'True'
# DATASET = 'FirstRingRoad'      #FirstRingRoad or PiduDistrict
# DEVICE = 'cuda:0'
# MODEL = 'MVGCRN'

#parser
args = argparse.ArgumentParser(description='arguments')
args.add_argument('--dataset', default='FirstRingRoad', type=str)
...
args.add_argument('--model', default='MVGCRN', type=str)
...
adj = torch.tensor(np.array(load_adj(args.dataset)))
adj_poi = torch.tensor(np.array(load_adj_poi(args.dataset)))

#init model
model = Network(args,adj.to(args.device),adj_poi.to(args.device))
